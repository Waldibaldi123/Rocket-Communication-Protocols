public class SCMPacket {
  ...
  */
  ...
  /** Takes the packet assigns its id and data to the instance variables
    * Also calls verifyChecksum to confirm packet accuracy
  ...
  public static void parsepacket(String packet) {
    ...
    String strChecksum =
      packetComponents[2].substring(0, packetComponents[2].length() - 1);
  ...
  /**
  * Takes the packet and calculates its checksum
  * It then compares the calculated checksum to the checksum sent with the packetComponents
  ...
  */
  private static boolean verifyChecksum(String packet, int checksum) {
